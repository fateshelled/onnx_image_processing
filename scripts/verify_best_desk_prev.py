"""Verify the room-best parameters with odom_ref overridden to 'prev'
on desk / desk2 (production NumPy matcher, loop_iterations=60).

Usage: .venv/bin/python scripts/verify_best_desk_prev.py
"""
...
params["odom_ref"] = "prev"  # only this is changed
...
payload = {"base": "room-best (trial 333), odom_ref overridden to prev",
           "params": params,
           "baseline": {"desk": 0.247, "desk2": 0.246},
           "verify": out}
json.dump(payload,
          open(REPO / "eval/results/verify_best_desk_prev.json", "w"),
          indent=2)
print("wrote eval/results/verify_best_desk_prev.json")
